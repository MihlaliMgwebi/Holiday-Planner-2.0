...
export const createTripFailure = createAction('[Trip Effect] Create Trip Failure', props<{ error: unknown }>());
// READ
...
export const getAllTripsFailure = createAction('[Trip Component] Get All Failure', props<{ error: unknown }>());
...
export const upsertTripFailure = createAction('[Trip Effect] Upsert Trip Failure', props<{ error: unknown }>());
...
export const deleteTripFailure = createAction('[Trip Effect] Delete Trip Failure', props<{ error: unknown }>());
