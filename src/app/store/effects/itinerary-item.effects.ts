...
export class ItineraryItemEffects {
  ...
  createItineraryItem$ = createEffect(()=> {
    return this.actions$.pipe(
      ...
      switchMap(({itineraryItem}) =>
        this.fireStoreService.createItineraryItem(itineraryItem)
          .pipe(
  ...
  getAllItineraryItems$ = createEffect(()=> {
    return this.actions$.pipe(
      ...
      switchMap(() => {
          console.log('Tim ')
          return this.fireStoreService.getAllItineraryItems()
            .pipe(
  ...
  upsertItineraryItem$ = createEffect(()=> {
    return this.actions$.pipe(
      ...
      switchMap(({upsertedItineraryItem}) =>
        this.fireStoreService.upsertItineraryItem(upsertedItineraryItem)
          .pipe(
  ...
  deleteItineraryItem$ = createEffect(()=> {
    return this.actions$.pipe(
      ...
      switchMap(({deletedItineraryItemId}) =>
        this.fireStoreService.deleteItineraryItem(deletedItineraryItemId)
          .pipe(
